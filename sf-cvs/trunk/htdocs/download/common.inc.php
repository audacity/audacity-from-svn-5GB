...
?>
  ...
  <li><p><?php printf(_('If you have trouble with your download, or need an older version of Audacity, try our <a href="%s">alternate download links</a> (older versions can be viewed by clicking on the appropriate package).'), "http://sourceforge.net/project/showfiles.php?group_id=6235")?></p></li>
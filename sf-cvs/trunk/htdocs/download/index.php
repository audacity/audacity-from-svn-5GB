...
<div class="download_container">
  ...
  <div class="downloads" id="beta_downloads">
    ...
    <div>
      ...
      <?=_("Windows")?></a><span class="downloads_smaller"><?=_("&nbsp;&nbsp;1.3.7")?></span></h3>
  
      <h3><a href="beta_mac"><img alt="Mac" src="../images/mac.png">
      <?=_("Mac OS X")?></a><br><img src="../images/download_spacer.png"><span class="downloads_smaller"><?=_("&nbsp;1.3.7 (Universal Binary)")?></span></h3>
  
      <h3><a href="beta_linux"><img alt="Linux" src="../images/unix.png">
      <?=_("Linux/Unix")?></a><br><img src="../images/download_spacer.png"><span class="downloads_smaller"><?=_("&nbsp;1.3.7 (in source code)")?></span></h3>
  </div>
</div>

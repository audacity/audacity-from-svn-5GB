...
echo _('<p>Audacity is <a href="../help/faq?s=general&amp;i=free">free software</a>; you may use it for any personal, commercial, or educational purpose, including installing it on as many different computers as you wish.</p>');

echo _('<p>You may also copy, distribute, modify, and/or resell Audacity, under the terms of the <a href="http://www.gnu.org/licenses/licenses.html#GPL">GNU General Public License (GPL)</a> as published by the Free Software Foundation; either version 2 of the License, or (at your option) any later version. In granting you this right, the GPL requires that the source code you distribute is itself available under the same GPL. If you have questions, please email us at the <a href="mailto:audacity-help@lists.sourceforge.net">Help list, audacity-help@lists.sourceforge.net</a>. (This is a public mailing list. For details, see our <a href="../contact/privacy">privacy policy</a>.)</p>');

echo _('<p>See also: <a href="http://www.gnu.org/licenses/gpl-faq.html">Frequently Asked Questions about the GNU GPL</a>.</p>');


echo _('<h3>Advice for Vendors and Distributors</h3>');

echo _('<p>Several third parties bundle Audacity with their products, resell, or distribute Audacity (see <a href="../download/bundlers">Vendors that Distribute Audacity</a>). Here are guidelines for bundling, reselling, or distributing Audacity. If you adhere to these guidelines, please <a href="../contact/">contact us</a> for possible inclusion at <a href="../download/bundlers">Vendors and Distributors of Audacity</a> (per instructions there).</p>');

echo _('<p>You must include, in accordance with Section 3 of the GPL:
  <ol>
...
echo _('<p>You may not advertise yourself or your business as an authorized distributor of Audacity. The name Audacity is a registered trademark of Dominic Mazzoni.</p>');

echo _('<p>See <a href="http://audacityteam.org/wiki/index.php?title=AudacityVendors#Advice_for_Vendors">Advice for Vendors</a> on the <a href="http://audacityteam.org/wiki">Audacity Wiki</a> for further advice.</p>');
?>

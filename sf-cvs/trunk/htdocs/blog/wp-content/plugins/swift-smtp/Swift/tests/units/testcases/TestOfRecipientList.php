...
class TestOfRecipientList extends UnitTestCase
{
   ...
   */
  function testAddressCanBeAddedAsStringOrSwift_Address()
  {
   ...
   */
  function testReturnedListsAreALWAYSOfTypeSwift_Address()
  {
    $list = new Swift_RecipientList();
   ...
   */
  function testDuplicateEntriesInSameFieldAreOverWritten()
  {
    $list = new Swift_RecipientList();
    $list->addCc(new Swift_Address("foo@bar.com"));
    $list->addCc("joe@bloggs.com", "Joe");
   ...
   */
  function testAddressesCanBeRemovedUsingObject()
  {
    $list = new Swift_RecipientList();

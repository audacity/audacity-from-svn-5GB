...
<p>
O Audacity é desenvolvido por uma equipe de voluntários em seu tempo livre. Se você gostou deste programa e quer ajudar, veja algumas idéias:
</p>
...
<p>
A lista de mensagens é o lugar onde os usuários do Audacity se encontram e trocam idéias, conhecimento e experiências. As mensagens são em inglês, mas se a comunidade luso e brasileira crescer, a criação de uma lista em português será muito bem-vinda!
<a href="http://lists.sourceforge.net/lists/listinfo/audacity-users">Ingresse na lista "Audacity-Users Mailing List"</a><br>
...
<a href="mailto:audacity-help@lists.sourceforge.net"
>diga-nos</a>.
Lembre-se sempre de dizer a maior quantidade possível de informações sobre o seu sistema (processador, sistema operacional, memória, etc) e como o problema acontece. 
<p>

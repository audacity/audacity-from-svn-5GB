<?php BoxTop("Nyquist - mantido em inglês"); ?>
</p><p>
<p>
Este documento trata da linguagem Nyquist, utilizada para a programação de efeitos e pós-processamento de áudio. Pela restrição de seu uso e baixa demanda, este documento não será traduzido ao português do Brasil, por nos parecer de maior importância verter recursos em projetos de uso mais difundido e genérico.</p><p>

Caso alguém se interesse em traduzi-lo seja bem-vindo! Entre em contato conosco e teremos prazer em ajudá-lo.
</p><p>

...
<p>След това, <b>за да изтеглите последното разклонение (1.1.0)</b> (пак на един ред):
<br>
   <ul><tt>cvs -z3 -d:pserver:anonymous@cvs.audacity.sourceforge.net:/cvsroot/audacity co
audacity</tt></ul>
или <b>за стабилното разклонение (0.9-1.0)</b> (на един ред):<br>
...
(вижте по-долу).<br>
След това, <b>за да изтеглите последното нестабилно разклонение (1.1.0)</b>, въведете<br> 
   <ul><tt>cvs checkout audacity</tt></ul>
или, <b>за стабилното разклонение (0.9-1.0)</b>, въведете <br>
...
на вашия компютър.
<p>
<b>За да получите стабилното разклонение (0.9-1.0): </b><br>
В диалоговия прозорец "Checkout Settings" въведете като име на модул
<tt>audacity-old</tt>. После, на страницата "Sticky options", отметнете
полето "Retrieve rev./tag/branch (-r)" и въведете <tt>audacity-0_9-branch</tt> в

...
използвани за оформяне на синтезираните музикални ноти: продължителност
на атаката (attack time), продължителност на затихването (decay time), 
продължителност на отзвучаването (release time), ниво на атаката
(attack level), ниво на затихването (decay level), ниво на задържането
...
Прагът може да бъде число с плаваща запетая или сигнал (за променливо
във времето филтриране) и се измерва в Хц.</td>
</tr>
...
<td>Прилага върху звука резонансен филтър (comb filter),
...
<td>Филтър, пропускащ всички честоти, който удължава звука без
    резонансите на филтъра comb.</td>
</tr>

<tr>
<td>(notch2 звук Хц)</td>
<td>Филтър за резки шумове (notch filter) от втори ред, центриран
около честота Хц.</td>
</tr>
...
<td>Променя дължината на звука според зададения множител.</td>
</tr>
...
<td>Започва звука със закъснение t секунди.<br>
    По този начин не можете да добавяте тишина в началото или края,<br>
    но можете да го използвате при комбиниране на звуци.</td>
</tr>

<tr>
<td>(seq (cue зв1) (cue зв2))</td>
<td>Създава последователност от звука зв1, последван от звука зв2.</td>
</tr>

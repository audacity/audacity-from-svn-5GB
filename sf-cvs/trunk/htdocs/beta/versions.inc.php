...
define('beta_win_exe_version', '1.3.3');

define('win_exe_version', '1.3.3');
define('win_exe_size',    2.6);

define('win_zip_version', '1.3.3');
define('win_zip_size',    3.4);

define('win_exe_unicode_version', '1.3.3');
define('win_exe_unicode_size',    2.6);

define('win_zip_unicode_version', '1.3.3');
define('win_zip_unicode_size',    3.4);
...
define('beta_src_version', '1.3.3');
define('src_version', '1.3.3');
define('src_size',    6.4);

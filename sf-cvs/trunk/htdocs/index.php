 ...
 */
  ...
  if ($download == "windows") {
    ...
    $beta_download_desc = _("for Windows&reg; 2000/XP/Vista <p>or <a href=\"http://audacity.sourceforge.net/download/beta_windows#ansi\">Audacity 1.3.7</a> <b>(Beta)</b> for Windows&reg; 98/ME</i></p><p>Read about provisional support for <a href=\"http://audacityteam.org/wiki/index.php?title=Windows_7_OS\">Windows 7</a>");

...
<div id="about">
  ...
  <p>
    <?=_('The latest release of Audacity is <a href="/download">1.3.8 (Beta)</a>. Because it is a work in progress and does not yet come with complete documentation or translations into foreign languages, it is recommended for more advanced users. See <a href="/download/features-1.3-a">New Features in 1.3</a> for more information about the 1.3.x Beta series.')?></p>
  <p>
    <?=_('For all users, <a href="/download">Audacity 1.2.6</a> is a stable release, complete and fully documented.  You can have Audacity 1.2.6 and 1.3.8 installed on the same machine.')?></p>
</div>

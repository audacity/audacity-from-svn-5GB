...
<p>
  <?php echo _('If you still have a question about how to use Audacity or problems doing so, please use our ');?>
  ...
  // your language.
  echo _('. You can search the Forum and may be able to find an immediate answer. If not, register at the Forum, confirm your registration and then log in. Choose the correct subforum to post to (for example, the Windows forum for Audacity 1.2.x) and click "New Topic". There are also foreign language subforums for French, German, Russian and Spanish.');?>
</p>
...
<p>We can only accept feedback in English at this time. Please note, this is a public mailing list. For details, see our <a href="../contact/privacy">Privacy Policy</a>.</p>

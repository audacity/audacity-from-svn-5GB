...
"\t\t\t<itemseparator/>",
"\t\t\t<item translation=\"Split\" keys=\"Ctrl+Y\" functions=\"OnSplit\"/>",
"\t\t\t<item translation=\"Split At Labels\" functions=\"OnSplitLabels\"/>",
"\t\t\t<item translation=\"Duplicate\" keys=\"Ctrl+D\" functions=\"OnDuplicate\"/>",
"\t\t\t<itemseparator/>",
...
"\t\t\t<itemseparator/>",
"\t\t\t<item translation=\"Undo History\" functions=\"UndoHistory\"/>",
"\t\t\t<item translation=\"Plot Spectrum\" keys=\"Ctrl+U\" functions=\"OnPlotSpectrum\"/>",
#ifndef __WXMAC__
"\t\t\t<itemseparator/>",
...
"\t\t\t\t<!-- Align keeping Cursor or Selection Submenu -->",
"\t\t\t\t<submenu translation=\"keeping Cursor or Selection\">",
...
"\t\t\t\t</submenu>",
"\t\t\t\t<!-- Align and move Cursor or Selection Submenu -->",
"\t\t\t\t<submenu translation=\"and move Cursor or Selection\">",
"\t\t\t\t\t<item translation=\"Align with Zero\" functions=\"OnAlignZeroMoveSel\"/>",
"\t\t\t\t\t<item translation=\"Align Group with Zero\" functions=\"OnAlignGroupZeroMoveSel\"/>",
"\t\t\t\t\t<itemseparator/>",
"\t\t\t\t\t<item translation=\"Align with Cursor\" functions=\"OnAlignCursorMoveSel\"/>",
"\t\t\t\t\t<item translation=\"Align with Selection Start\" functions=\"OnAlignSelStartMoveSel\"/>",
"\t\t\t\t\t<item translation=\"Align with Selection End\" functions=\"OnAlignSelEndMoveSel\"/>",
"\t\t\t\t\t<itemseparator/>",
"\t\t\t\t\t<item translation=\"Align End with Cursor\" functions=\"OnAlignEndCursorMoveSel\"/>",
"\t\t\t\t\t<item translation=\"Align End with Selection Start\" functions=\"OnAlignEndSelStartMoveSel\"/>",
"\t\t\t\t\t<item translation=\"Align End with Selection End\" functions=\"OnAlignEndSelEndMoveSel\"/>",
"\t\t\t\t\t<itemseparator/>",
"\t\t\t\t\t<item translation=\"Align Group with Cursor\" functions=\"OnAlignGroupCursorMoveSel\"/>",
"\t\t\t\t\t<item translation=\"Align Group with Selection Start\" functions=\"OnAlignGroupSelStartMoveSel\"/>",
"\t\t\t\t\t<item translation=\"Align Group with Selection End\" functions=\"OnAlignGroupSelEndMoveSel\"/>",
"\t\t\t\t\t<itemseparator/>",
"\t\t\t\t\t<item translation=\"Align Group End with Cursor\" functions=\"OnAlignGroupEndCursorMoveSel\"/>",
"\t\t\t\t\t<item translation=\"Align Group End with Selection Start\" functions=\"OnAlignGroupEndSelStartMoveSel\"/>",
"\t\t\t\t\t<item translation=\"Align Group End with Selection End\" functions=\"OnAlignGroupEndSelEndMoveSel\"/>",
"\t\t\t\t</submenu>",
"\t\t\t</submenu>",
"\t\t\t<itemseparator/>",
...
"//EOF//"
   ...
   COMMANDS_ADDTRANSLATIONSTRING(_("keeping Cursor or Selection..."), "keeping Cursor or Selection");
   COMMANDS_ADDTRANSLATIONSTRING(_("and move Cursor or Selection..."), "and move Cursor or Selection");

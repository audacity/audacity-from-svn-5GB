...
WahwahDialog::WahwahDialog( wxWindow *parent, wxWindowID id, const wxString &title,
...
wxSizer *CreateWahwahDialog( wxPanel *parent, bool call_fit, bool set_sizer )
{
    wxBoxSizer *item0 = new wxBoxSizer( wxVERTICAL );

    wxStaticText *item1 = new wxStaticText( parent, ID_TEXT, "Wahwah by Nasca Octavian Paul", wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText *item20 = new wxStaticText( parent, ID_TEXT, "Resonance:", wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
    item10->Add( item20, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxTextCtrl *item21 = new wxTextCtrl( parent, ID_RESONANCETEXT, "", wxDefaultPosition, wxSize(40,-1), 0 );
    item10->Add( item21, 0, wxALIGN_CENTRE|wxALL, 5 );

    wxSlider *item22 = new wxSlider( parent, ID_RESONANCESLIDER, 0, RES_MIN, RES_MAX, wxDefaultPosition, wxSize(100,-1), wxSL_HORIZONTAL );
    item10->Add( item22, 0, wxALIGN_CENTRE|wxALL, 5 );

    wxStaticText *item30 = new wxStaticText( parent, ID_TEXT, "Wah Frequency Offset (%):", wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
    item10->Add( item30, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

    wxTextCtrl *item31 = new wxTextCtrl( parent, ID_FREQOFFTEXT, "", wxDefaultPosition, wxSize(40,-1), 0 );
    item10->Add( item31, 0, wxALIGN_CENTRE|wxALL, 5 );

    wxSlider *item32 = new wxSlider( parent, ID_FREQOFFSLIDER, 0, FREQOFF_MIN, FREQOFF_MAX, wxDefaultPosition, wxSize(100,-1), wxSL_HORIZONTAL );

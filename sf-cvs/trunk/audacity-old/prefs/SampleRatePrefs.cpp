...
PrefsPanel(parent)
{
   ...
   mDefaultSamplingRate = new wxRadioBox(this, -1, "Default Project Sample Rate", wxPoint(PREFS_SIDE_MARGINS, PREFS_TOP_MARGIN), wxSize(GetSize().GetWidth() - PREFS_SIDE_MARGINS * 2, GetSize().GetHeight() - (2 * PREFS_TOP_MARGIN)), 5,      // number of items
                                         stringRates, 1);

 ...
 * Last changed  : $Date: 2004-06-09 05:04:55 $

 * File revision : $Revision: 1.3 $

 *

 * $Id: STTypes.h,v 1.3 2004-06-09 05:04:55 vjohnson Exp $
...

{
    ...
    #define FLOAT_SAMPLES       // 32bit float samples
        ...
        /* Disable 3DNow! and SSE for Audacity, for maximum build portability.

 ...
 *
 * Last changed  : $Date: 2004-07-21 16:08:18 $
 * File revision : $Revision: 1.3 $
 *
 * $Id: TDStretch.cpp,v 1.3 2004-07-21 16:08:18 jamescrook Exp $
 *
 * License :
 * 
                              ...
                              uint seekWindowMS, uint overlapMS)
{
    ...
    overlapLength = (uint)pow(2, overlapDividerBits);

    slopingDividerBits = 2 * (overlapDividerBits - 1) - 1;
    slopingDivider = (uint)pow(2, slopingDividerBits);

...
<pre>
Kende problemer og underligheder:

* Windows: Den flydende værktøjslinje minimerer ikke sammen med
  projektvinduet. En midlertidig løsning er at forankre den i
  projektvinduet i stedet for at lade den være flydende.

* Linux: Fuld duplex (afspilning af et spor samtidig med optagelse
  af et andet) virker ikke, selv hvis dit lydkort tilsyneladende
  understøtter det.

* Linux: Lydkort, der kun kan håndtere <u>mere</u> end to lydkanaler
  er ikke understøttet endnu.
...
Nyt i 1.0:
  ...
  * Mac OS:
    ...
    - Audacity lukker nu ikke ved lukning af vinduet. Menulinen 
      forbliver, og du kan bruge den til at åbne et nyt vindue.

    - Rettede en fejl, der forhindrede Indstillinger-dialogen i 
      at blive vist i Mac OS 9 med ATM kontrolpanelet.

    - Rettede en fejl der forhindrede indspilning med lave frekvenser
	under Mac OS 9.
      
    - Genkender MP3-filer på efternavn og typekode.

    - Fungerer bedre og mere stabilt under MacOS X

  * Nye faciliteter:

    - "Gem ændringer" dialogboks tilføjet på alle platforme.

    - Værktøjstips

    - Nye tastaturgenvej og -kommandoer.

    - Etiketter kan nu bruges til at markere regioner.
      Etiketter laves med en ny kommando - se brugervejledningen.

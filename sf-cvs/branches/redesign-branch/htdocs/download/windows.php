...
<ul>
  <li><p><?php printf('<a href="%s">Audacity %s installer</a> (.exe file, %.1lf MB) - The latest version of the free Audacity audio editor.', "../latest/".$win_exe_url, win_exe_version, win_exe_size)?></p></li>
</ul>

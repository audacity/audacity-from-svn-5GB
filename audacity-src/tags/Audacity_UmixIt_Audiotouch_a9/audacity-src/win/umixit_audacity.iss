...
; No version number, so we don't have to change autorun.inf for the Enhanced CD:   OutputBaseFilename=audacity_umixit-win-1.2.6
...
; Filename: "{app}\audacity.exe"; Parameters: """{userdesktop}\UmixIt_Content\Billy_ogg.aup"""; Description: "Launch Audacity with Billy_ogg project"; Flags: nowait postinstall skipifsilent

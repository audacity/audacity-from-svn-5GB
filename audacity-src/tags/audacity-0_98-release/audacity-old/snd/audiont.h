...
//ROger also defined it as snd_bytes_per_frame() in snd.h
#define bpers(a) ((int)((a).channels * (((a).bits+7)>>3))) //bytes in one sample of a given format (call this with format_node)

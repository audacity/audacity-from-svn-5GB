...
// ----------------------------------------------------------------------------
    ...
    #undef HAVE_STRPTIME
        ...
        // Vaughan Johnson, 2010-06-14 
        // unknown platform as in #else clause, but we've upgraded to VC8 or higher, where _timezone is 
        // deprecated, per http://msdn.microsoft.com/en-us/library/htb3tdkc%28VS.80%29.aspx.
        static long wxGetTimeZone()
        {
           long seconds;

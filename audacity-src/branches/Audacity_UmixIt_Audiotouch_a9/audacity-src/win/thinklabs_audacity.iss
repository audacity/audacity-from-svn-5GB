...
AppName=Thinklabs Phonocardiography, powered by Audacity
AppVerName=Thinklabs Phonocardiography, powered by Audacity 1.2.6
AppPublisherURL=http://audacity.sourceforge.net
AppSupportURL=http://audacity.sourceforge.net
AppUpdatesURL=http://audacity.sourceforge.net
ChangesAssociations=yes
DefaultDirName={pf}\Thinklabs_Phonocardiography_powered_by_Audacity
...
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\beat.ny"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\clicktrack.ny"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\crossfadein.ny"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\crossfadeout.ny"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\delay.ny"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
...
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\GVerb.dll"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\Hard Limiter.dll"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
...
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\pluck.ny"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\sc4.dll"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\SilenceMarker.ny"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
; not for Thinklabs   Source: "..\win\Release\Plug-Ins\tremolo.ny"; DestDir: "{app}\Plug-Ins"; Flags: ignoreversion
...
Name: "{userdesktop}\Thinklabs Phonocardiography, powered by Audacity"; Filename: "{app}\audacity.exe"; MinVersion: 4,4; Tasks: desktopicon
...
; For Thinklabs, default to no MixerToolbar and no MeterToolbar.
; NOT NECESSARY, just do it with defaults in the code. 
; Root: HKCU; Subkey: "Software\Audacity\Audacity\GUI"; ValueType: dword; ValueName: "EnableMixerToolBar"; ValueData: "0"
; Root: HKCU; Subkey: "Software\Audacity\Audacity\GUI"; ValueType: dword; ValueName: "EnableMeterToolBar"; ValueData: "0"
; Thinklabs has lower default (2kHz) for Spectrum max freq than standard Audacity (8kHz)
; Root: HKCU; Subkey: "Software\Audacity\Audacity\Spectrum"; ValueType: dword; ValueName: "MaxFreq"; ValueData: "1000"

...
void AudacityProject::CreateMenusAndCommands()
{
   ...
   gPrefs->Read("/Transport/bWantPlayAfterOpen", &m_bWantPlayAfterOpen, true);
   c->AddItem("PlayAfterOpen", 
               m_bWantPlayAfterOpen ? 
                  _("Do Not Play after File Open\tCtrl+Shift+O") : 
                  _("Play after File Open\tCtrl+Shift+O"),  
               FN(OnPlayAfterOpen));

   gPrefs->Read("/Transport/bWantPlayAfterRecord", &m_bWantPlayAfterRecord, true);
   c->AddItem("PlayAfterRecord", 
...
void AudacityProject::OnNew()
{
   ...
   void AudacityProject::OnEmail()
   {
      ...
      //   wxHtmlLinkInfo(
      //      wxT("mailto:<recipient>&attach=\"C:/V_data/sfw_dev/Audacity_Voice/audacity/win/Output\"")));
   }
#endif
...
void AudacityProject::OnBenchmark()
{
   ...
   void AudacityProject::OnPlayAfterOpen()
   {
      ...
      mCommandManager.Modify(
         "PlayAfterOpen", 
         m_bWantPlayAfterOpen ? 
            _("Do Not Play after File Open") : 
            _("Play after File Open")); 
	   gPrefs->Write("/Transport/bWantPlayAfterOpen", m_bWantPlayAfterOpen);
   }
   ...
   void AudacityProject::OnPlayAfterRecord()
   {
      ...
      mCommandManager.Modify(
         "PlayAfterRecord", 
         m_bWantPlayAfterRecord ? 
            _("Do Not Play after Record") : 
            _("Play after Record")); 
	   gPrefs->Write("/Transport/bWantPlayAfterRecord", m_bWantPlayAfterRecord);
   }

   void AudacityProject::OnLockUnlock()
   {
      m_bWantLockedRecording = !m_bWantLockedRecording;
      ControlToolBar *toolbar = GetControlToolBar();
      toolbar->SetLock(m_bWantLockedRecording);
      mCommandManager.Modify(
         "Lock/Unlock", 
         toolbar->IsLocked() ? 
            _("Unlock Recording") : 
            _("Lock Recording"));
	   gPrefs->Write("/Transport/bWantLockedRecording", m_bWantLockedRecording); 
   }
   ...
   void AudacityProject::OnAppendRecording()
   {
      ...
      mCommandManager.Modify(
         ...
         m_bWantAppendRecording ? 
            _("Do Not Append Recording") : 
            _("Append Recording"));
	   gPrefs->Write("/Transport/bWantAppendRecording", m_bWantAppendRecording); 
   }
   ...
   void AudacityProject::OnAboutBrand()
   {
      LinkToPathlistHTM(FROMFILENAME("Audacity_Voice-about.htm"));
   }

   //void AudacityProject::OnDifferences()
   //{
   //   LinkToPathlistHTM(FROMFILENAME("Audacity_Voice-diffs.htm"));
   //}

   void AudacityProject::OnGetAudiotouch()
   {
      LinkToPathlistHTM(FROMFILENAME("Audacity_Voice-download.htm"));
   }

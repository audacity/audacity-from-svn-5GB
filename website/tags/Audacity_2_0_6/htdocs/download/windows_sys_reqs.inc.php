...
<table class="winsysreq">
  ...
  <tr>
    <td>Windows Vista (Home Basic) (32-&nbsp;or&nbsp;64-bit)/Windows 7 Starter</td>
    <td>2 GB / 1 GHz</td>
    <td>512 MB / 1 GHz</td>
  </tr>
  <tr>
...
<p>&nbsp;</p>
<p>
  <?=_("Generally, Audacity works best on computers meeting more than the minimum requirements in the table above. Where Audacity is to be used for lengthy multi-track projects, we recommend using Windows XP, Vista, Windows 7 or Windows 8 running on machines of substantially higher specification than the minimum stated above.")?>
</p>

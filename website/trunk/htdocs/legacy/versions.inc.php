...
define('macosx_legacy_version', '1.2.6a');
define('macosx_legacy_size',    3.9);
define('macosx_intel_version', '1.2.5');
define('macosx_intel_size',    3.4);

define('win_legacy_exe_version', '1.2.6');
define('win_legacy_exe_size',    2.1);
define('win_legacy_zip_version', '1.2.6');
define('win_legacy_zip_size',    3.0);

define('ladspa_legacy_version', '0.4.15');
define('ladspa_legacy_size',    1.5);

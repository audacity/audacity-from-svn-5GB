...
<h3 id="details"><?=_("Changes in Audacity 2.0 (from 1.3.14, last in the 1.3 series)")?></h3>
...
<?=_('
    ...
    <ul>
      <li>Fixed a crash importing MP3 files that had duplicate metadata tags 
        ...
        against an affected version of system libsndfile).</li> 
      <li>Fixed an issue where excessively high or corrupted sample values in
        the audio could corrupt exports from the start of the problem for
        the rest of the file, and could corrupt the rest of the project.</li> 
      <li>(Linux) Fixed Audacity could not be compiled against FFmpeg
        0.7.x and 0.8.x.</li>
    </ul>
    </dd>
')?>
...
<?=_('
    ...
    <ul>
      <li>Fixed crash on launch when using "Ambisonic Decoders (PC)" VST  
        plug-ins and other plug-ins that enable additional floating point
        exceptions.</li>  
      <li>Fixed Plot Spectrum background could be transparent on some machines.</li>  
      <li>Bug fixes for Click Track, High Pass, Low Pass and Vocal Remover.</li>  
      <li>Chirp, Tone and Silence generators now remember their settings.</li>  
    </ul>
    </dd>
')?>
...
<?=_('
    ...
    <ul>
      <li>New Interface preference to show the track name in the display (off by default).</li>   
      <li>Longer default Playback preference for effects preview and preview before cut.</li>   
      <li>Restored use of Page Up and Page Down to scroll horizontally.</li>  
    </ul>
    </dd>
</dl>
')?>

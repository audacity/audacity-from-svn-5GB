...
<p>
 <ul>
   ...
   <li><a href="http://wiki.audacityteam.org/">Audacity Wiki</a> is an extensive user-editable help resource including:
    <ul><li><a href="http://wiki.audacityteam.org/wiki/Category:Tutorial">Tutorials</a> - Additional and more specialised tutorials, links to <a href="http://wiki.audacityteam.org/wiki/Category:Tutorial#external">other tutorials on the web</a> and  <a href="http://wiki.audacityteam.org/wiki/MultiLingual">support forums in other than English</a>.</li>

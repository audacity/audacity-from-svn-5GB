...
")
        ...
        "multi-track" => array(
          ...
          _("<p>This is called multi-track recording.  It makes it possible to record harmonies with yourself, or add new instruments or vocals to an existing recording.  To do this in Audacity, open the \"Recording\" tab of Audacity preferences and check the box labeled <b>Overdub: Play other tracks while recording new one.</p>
<p>See also:
	<ul>
...
")
  ...
  if ($faqSectionId != "" && $itemId != "") {
    ...
    echo "<p>"._('These are older Frequently Asked Questions (FAQ), <b>only for those languages where the latest <a href="faq">FAQ</a> doesn\'t yet have a translation.</b> These questions remain largely valid for Audacity 2.0, but please use the latest FAQ if you can do so.')."</p>";
